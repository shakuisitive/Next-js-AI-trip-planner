...
interface EditingAccommodation {
  id: string
  field: "name" | "type" | "pricePerNight" | "description" | "bookingUrl" | "amenities" | "rating"
            ...
            <TableBody>
              {sortedAccommodations.map((accommodation) => (
                <TableRow key={accommodation.id}>
                  ...
                  <TableCell className="text-center">{renderStars(accommodation.rating)}</TableCell>
                  <TableCell
                    className="text-center cursor-pointer hover:bg-slate-50 transition-colors"
                    onClick={() =>
                      !editingAccommodation &&
                  ...
                  <TableCell 
                    className="text-center max-w-xs cursor-pointer hover:bg-slate-50 transition-colors"
                    onClick={() =>
                      !editingAccommodation &&
